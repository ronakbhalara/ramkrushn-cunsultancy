...
export default function IncomeTaxDocumentsSection({ incomeTaxId }) {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await fetch(`/api/income-tax-documents?incomeTaxId=${incomeTaxId}`);
  ...
  return (
    <>
      ...
      <div className="animate-in fade-in-50 duration-500 delay-400 mt-6">
        <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">Documents</h4>
            ...
            <div key={doc.id} className="flex items-start space-x-3">
              <div className="flex-shrink-0">
                {doc.mime_type?.startsWith('image/') ? (
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-white border border-gray-200 rounded-lg group">

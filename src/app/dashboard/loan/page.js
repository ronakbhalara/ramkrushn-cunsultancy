      ...
      <div className="sm:flex block justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-semibold transition-colors ${statusFilter === "PENDING"
                ? "bg-[#dfc797] text-[#17312d]"
                : "bg-gray-200 text-gray-700 hover:bg-gray-300"
              }`}
          >
                                ...
                                <div className="animate-in fade-in-50 duration-500 delay-300">
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div>
                                      ...
                                      <span
                                        className={`inline-block px-2 py-1 text-xs font-semibold rounded-full ${loan.stage === "ACTIVE"
                                          ? "bg-green-100 text-green-800"
                                          : loan.stage === "PENDING"
                                            ? "bg-yellow-100 text-yellow-800"
                                            : "bg-blue-100 text-blue-800"
